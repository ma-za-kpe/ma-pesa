 ...
 */
class TenEightFragment : Fragment(), RewardedVideoAdListener {

    private lateinit var mRewardedVideoAd: RewardedVideoAd

    private lateinit var binding: FragmentTenEightBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_ten_eight, container, false)
    ...
    override fun onRewarded(reward: RewardItem) {
        ...
        navController.navigate(R.id.tenNineFragment)
