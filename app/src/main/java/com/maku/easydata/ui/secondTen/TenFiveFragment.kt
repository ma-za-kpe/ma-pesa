...
import com.maku.easydata.databinding.FragmentTenFiveBinding
 ...
 */
class TenFiveFragment : Fragment(), RewardedVideoAdListener {

    private lateinit var mRewardedVideoAd: RewardedVideoAd

    private lateinit var binding: FragmentTenFiveBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_ten_five, container, false)
        ...
        val mystring = resources.getString(R.string.videos_to_g_seven);
    ...
    override fun onRewarded(reward: RewardItem) {
        ...
        Toast.makeText(activity, "6 more videos to go",
                Toast.LENGTH_SHORT).show()
        // Reward the user // move to next activity
        navController.navigate(R.id.tenSixFragment)
