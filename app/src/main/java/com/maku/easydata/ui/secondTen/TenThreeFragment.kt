 ...
 */
class TenThreeFragment : Fragment(), RewardedVideoAdListener {

    private lateinit var mRewardedVideoAd: RewardedVideoAd

    private lateinit var binding: FragmentTenThreeBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_ten_three, container, false)
        ...
        val mystring = resources.getString(R.string.videos_to_g_nine);
    ...
    private fun loadRewardedVideoAd() {
        ...
        if (!(::mRewardedVideoAd.isInitialized) || !mRewardedVideoAd.isLoaded) {
            ...
            mRewardedVideoAd.loadAd(BuildConfig.AD_3,
    ...
    override fun onRewarded(reward: RewardItem) {
        ...
        Toast.makeText(activity, "8 more videos to go",
                Toast.LENGTH_SHORT).show()
        // Reward the user // move to next activity
        navController.navigate(R.id.tenFourFragment)
