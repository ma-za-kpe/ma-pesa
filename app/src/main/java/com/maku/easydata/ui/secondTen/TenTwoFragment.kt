...
import com.maku.easydata.databinding.FragmentTenTwoBinding
import timber.log.Timber

/**
 * A simple [Fragment] subclass.
 */
class TenTwoFragment : Fragment(), RewardedVideoAdListener {

    private lateinit var mRewardedVideoAd: RewardedVideoAd

    private lateinit var binding: FragmentTenTwoBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_ten_two, container, false)
        ...
        val mystring = resources.getString(R.string.videos_to_g_nine_ten);
    ...
    override fun onRewarded(reward: RewardItem) {
        ...
        Toast.makeText(activity, "9 more videos to go",
                Toast.LENGTH_SHORT).show()
        // Reward the user // move to next activity
        navController.navigate(R.id.tenThreeFragment)
