...
import com.maku.easydata.databinding.FragmentTenSevenBinding
import com.maku.easydata.databinding.FragmentTenSixBinding
 ...
 */
class TenSevenFragment : Fragment(), RewardedVideoAdListener {

    private lateinit var mRewardedVideoAd: RewardedVideoAd

    private lateinit var binding: FragmentTenSevenBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_ten_seven, container, false)
        ...
        val mystring = resources.getString(R.string.videos_to_g_five);
    ...
    override fun onRewarded(reward: RewardItem) {
        ...
        navController.navigate(R.id.tenEightFragment)
